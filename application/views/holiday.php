<!doctype html>
<html class="no-js" lang="en"  ng-app="myApp" ng-controller="manageHoliday" ng-cloak>
					...
					<div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body pb-0 text-right">
								...
								<button type="button" onClick="sampleHolidayCsv()" class="btn btn-rounded btn-secondary mb-4 ml-3">Download Sample</button>
                            </div>
                        </div>
                    </div>
				</div>
								...
								<div class="row" id="custHeader">
									...
									<div class="col-12 col-sm-6 custS">
										<div class="input-group sinp m-auto-search mw-250 mb-2">
											<input type="text" class="form-control pull-right" ng-model="keywords" ng-change="getdidList()" placeholder="Search Holiday Date">
                                    ...
                                    <table class="table text-center">
                                        <thead class="text-capitalize">
                                            <tr>
                                                ...
                                                <th  ng-click="sort('holidayno')">Holiday Date<span class="glyphicon sort-icon" ng-show="sortKey=='holidayno'" ng-class="{'ti-arrow-up':reverse, 'ti-arrow-down':!reverse}"></span></th><th  ng-click="sort('isglobal')">IS Global<span class="glyphicon sort-icon" ng-show="sortKey=='isglobal'" ng-class="{'ti-arrow-up':reverse, 'ti-arrow-down':!reverse}"></span></th>
                                        ...
                                        <tbody>
                                            <tr  dir-paginate="list in didlist|orderBy:sortKey:reverse|itemsPerPage:pageSize"   ng-click="selectedRow($index,list);" ng-class="{activeRow : selRow == $index}" total-items="totalCount">
                                                <td align="left">{{$index+1}}<label class="checkbox-container"><input type="checkbox"  name="location[]" value="{{list.id}}"><span class="checkmark"></span></label></td>
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Holiday Edit</h5>
					...
					<div class="single-table">
						<div id="table" class="table-editable">
							<div class="container1">
								...
								<input type="date" id="date" class="form-control" ng-model="didedit.date">
								</div>
								...
								<div class="form-group">
									<label for="didedit">DID:</label>
									<input type="tel" id="didedit" class="form-control" numbers-only maxlength="10" ng-model="didedit.did">
								</div>
